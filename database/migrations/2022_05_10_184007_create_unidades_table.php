    ...
    public function up()
    {
        Schema::create('unidades', function (Blueprint $table) {
         ...
         Schema::table('produtos', function (Blueprint $table) {
            ...
            $table->foreign('unidade_id')->references('id')->on('unidades'); //N:1 produtos:unidade
        });

        //adicionar o relacionamento com a tabela produto_detalhes
        Schema::table('produto_detalhes', function (Blueprint $table) {
            $table->unsignedBigInteger('unidade_id');
            $table->foreign('unidade_id')->references('id')->on('unidades'); //N:1 produto_detalhes:unidade
        });
    }
